            ...
            <div className="row mx-3 mt-5">
                ...
                <div className="card text-up-anim bg-dark text-white col-sm-6 col-12">
                        ...
                        <div className="card-img-top overflow">
                            <img src="./images/merng.gif" alt="Portfolio App" className="card-img-top img-hover"/>
                        </div>
                        </a>   
...
{/* 
                    ...
                    <div className="card text-up-anim2 bg-dark text-white col-sm-6 col-12 overflow">
                        ...
                        <div className="card-img-top overflow">
                        <img src="./images/mockup.gif" alt="Restaurant App" className="card-img-top img-hover"/>
                        </div>
                        </a>
                        <div className="card-body">
                            <h4 className="card-title">React SaaS Site</h4>
                            <p className="card-text">
                            React.js, Styled-Components, ReactStrap, Bootstrap, Semantic-UI, React-Router
                            </p>
                            <p className="card-text">
                            Refactored a wordpress build with elementor site, into a functional React based site for responsiveness.
                            Focused on user experience and ux/ui design.
                            </p>
                        </div>
                        <div className="card-footer">
