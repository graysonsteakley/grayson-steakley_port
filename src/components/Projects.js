    ...
    <BaseContainer>
      <div className='container'>
        <div className='row mx-3 mt-5'>
          <HeadingText className='text-center'>Projects</HeadingText>
        </div>
        <div className='row mx-3 mt-5'>
          <div className='card-deck'>
            <div className='card text-up-anim bg-dark text-white col-sm-6 col-12'>
              ...
              <div className='card-body'>
                <h4 className='card-title'>MERNG Post Site</h4>
                <p className='card-text'>
                  MERNG Stack, React, MongoDB, GraphQL, Express, Node.js,
                  Semantic-UI, Context API
                </p>
                <p className='card-text'>
                  Built a functional full-stack post site that sends and
                  receives data through an Apollo Graph-QL server to MongoDB.
                  Users, posts, likes, and comments are stored in the database.
                  Client side data is moved through a separate context Api
                  store. Apollo brings the back-end and client side structures
                  together.
                </p>
              </div>
            ...
            <div className='card text-up-anim2 bg-dark text-white col-sm-6 col-12 overflow'>
              ...
              <div className='card-body'>
                <h4 className='card-title'>React SaaS Site</h4>
                <p className='card-text'>
                  React.js, Styled-Components, ReactStrap, Bootstrap,
                  Semantic-UI, React-Router
                </p>
                <p className='card-text'>
                  Refactored a wordpress build with elementor site, into a
                  functional React based site for responsiveness. Focused on
                  user experience and ux/ui design.
                </p>
              </div>
              <div className='card-footer'>
                <a
          ...
          <div className='card-deck mb-5'>
            <div className='card bg-dark text-white col-sm-6 col-12'>
              ...
              <div className='card-body'>
                ...
                <p className='card-text'>
                  Built a functional Ecommerce Website that asynchronously
                  retrieves data from a product API, then stores that data into
                  a separate Context API state. The Context API holds multiple
                  functions that tabulates product pricing and which items are
                  currently placed in the cart.{" "}
                </p>
              </div>
              <div className='card-footer'>
                <a
            ...
            <div className='card bg-dark text-white col-sm-6 col-12'>
              ...
              <div className='card-body'>
                ...
                <p className='card-text'>
                  React.js, PHP, React-Router, Styled-Components, Functional
                  Animations
                </p>
                <p className='card-text'>
                  Built a multi page application with SVG / mobile scalable
                  design. Includes a PHP email submission, and project showcase.
                </p>
              </div>
              <div className='card-footer'>
