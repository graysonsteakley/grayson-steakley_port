  ...
  render() {
    return (
      <BaseContainer className='contact'>
        <HeadingText className='text-center text-uppercase mb-5 text-up-anim2'>
          CONTACT
        </HeadingText>
        <SubHeader className='text-center border-top text-up-anim'>
        ...
        <MainContentWrapper>
          <Form
            ...
            className='text-down-anim text-light login-form'
          >
